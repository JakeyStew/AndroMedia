...
public class Topic_4 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_topic_4);
        ...
        TextView tx11 = (TextView)findViewById(R.id.Scroll_Text11);
        TextView tx12 = (TextView)findViewById(R.id.Scroll_Text12);
        ...
        tx11.setTypeface(custom_font);
        tx12.setTypeface(custom_font);
    ...
    /*-- Intent to change from Topic_4 to the Topicss screen --*/
    public void backClick(View view) {
        Intent intent = new Intent(this, Topics.class);
        startActivity(intent);
    }

    /*-- Intent to change from Topic_4 to menu screen --*/
